# Copyright (C) 2020 Randy.
#
# Licensed under the Raphielscape Public License, Version 1.c (the "License");
# you may not use this file except in compliance with the License.
#

# Bloodless UserBot - Randy
...
UNAPPROVED_MSG = ("`Hey! Bu bir. Endişelenme.\n\n`"
...
try:  
    ...
    PLUGIN_MESAJLAR = {}
    ORJ_PLUGIN_MESAJLAR = {"alive": "`Bloodless UserBot💥 sizin için çalışıyor💫.`", "afk": str(choice(AFKSTR)), "kickme": "Güle Güle ben gidiyorum 🤠", "pm": UNAPPROVED_MSG, "dızcı": str(choice(DIZCILIK_STR))}
...
LOGS.info("Botunuz çalışıyor! Herhangi bir sohbete .alive yazarak Test edin."
          " Yardıma ihtiyacınız varsa, Destek grubumuza gelin t.me/BloodlessUserBotSupport")
LOGS.info("Bot sürümünüz Bloodless v1.3")
